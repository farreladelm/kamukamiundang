...
export default async function AdminTemplatesPage() {
  ...
  return (
    <section>
      <p className="text-xs font-semibold tracking-[0.18em] text-stone-500 uppercase">Source-controlled collection</p>
      <h1 className="mt-2 font-serif text-5xl">Template</h1>
      <p className="mt-4 text-sm leading-6 text-stone-600">Admin hanya mengubah visibilitas. Desain, versi, palette, dan harga tetap berasal dari source code.</p>
